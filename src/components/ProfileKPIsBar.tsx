...
export const ProfileKPIsBar: React.FC<ProfileKPIsBarProps> = ({ kpis }) => {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
      ...
      <div className="p-4 rounded-xl bg-[#181614] border border-[#38332e] shadow-sm flex flex-col justify-between">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-3xl font-headline font-bold text-[#f4efe6]" data-testid="kpi-total-tops">
            {kpis.totalTops}
          </span>
          <span className="text-xs font-mono text-[#78716c]">Routen</span>
        </div>
        <span className="text-[10px] font-mono text-[#78716c] mt-1">inkl. aller Flashes</span>
      </div>
      ...
      <div className="p-4 rounded-xl bg-[#181614] border border-[#38332e] shadow-sm flex flex-col justify-between">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-3xl font-headline font-bold text-[#f59e0b]" data-testid="kpi-total-flashes">
            {kpis.totalFlashes}
          </span>
          <span className="text-xs font-mono text-[#78716c]">im 1. Versuch</span>
        </div>
          ...
          {kpis.bestTop ? (
            <div className="flex items-center gap-2">
              ...
              <div className="truncate">
                <span className="text-lg font-headline font-bold text-[#f4efe6] block truncate">
            ...
            <span className="text-2xl font-headline font-bold text-[#78716c]">–</span>
          )}
        </div>
        <span className="text-[10px] font-mono text-[#78716c] mt-1">Höchstes Farbband</span>
      </div>
      ...
      <div className="p-4 rounded-xl bg-[#181614] border border-[#38332e] shadow-sm flex flex-col justify-between">
        ...
        <span className="text-[10px] font-mono text-[#78716c] mt-1">Geflashtes Maximum</span>
      </div>
    </div>
  );
};
